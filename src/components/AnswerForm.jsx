      ...
      <div className="w-full bg-white rounded-lg p-3 sm:p-6 flex flex-col items-center justify-center text-gray-900 border border-gray-200">
        {levelIndex >= levels.length ? (
          <div className="text-center">
            <h2 className="text-xl font-bold text-green-600 mb-2">🎉 সব লেভেল সম্পূর্ণ!</h2>
            <p className="mb-3 text-base text-gray-700">আপনি সব প্রশ্ন শেষ করেছেন। আপনি কি লেভেল ১ থেকে আবার শুরু করতে চান?</p>
            <button
              onClick={onRestart}
